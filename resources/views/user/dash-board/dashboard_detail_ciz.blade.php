                ...
                <div class="dashboard-content-wrap">
                    <div class="device-wrap" style="width: 770px; height: 370px; margin: 80px;">
                        ...
                        <div class="device-item-group device-item-sub-group" style="top: 200px; left: 400px;">
                            ...
                            <div class="device-item device-btn down m-script-pop" data-target="#pop2"
                            ...
                            <div class="device-item device-btn down m-script-pop" data-target="#pop3" data-title="Emergency Shutdown System">
                            ...
                            <div class="device-item device-btn down m-script-pop" data-target="#pop4" data-title="DF G/E Control System">
                                <div class="state state-num">6</div>
                                <img src="/images/dashboard_icon_system.png" alt="">
                                <p class="device-item-title">
                            ...
                            <div class="device-item device-btn down m-script-pop" data-target="#pop5" data-title="Valve Remote Control System">
                                <div class="state state-num">4</div>
                                <img src="/images/dashboard_icon_system.png" alt="">
                                <p class="device-item-title">
                        ...
                        <div class="device-item-group device-item-sub-group" style="top: 400px; left: 400px;">
                            <!-- 하위 그룹 및 일렬 정렬 시 device-item-sub-group -->
                            <div class="device-item device-btn down m-script-pop" data-target="#pop6" data-title="Anti-Heeling System">
                                <div class="state state-num">6</div>
                                <img src="/images/dashboard_icon_system.png" alt="">
                                <p class="device-item-title">
                                    Anti-Heeling System
                            ...
                            <div class="device-item device-btn down m-script-pop" data-target="#pop7" data-title="Shaft Power Meter">
                                <div class="state state-num">6</div>
                                <img src="/images/dashboard_icon_system.png" alt="">
                                <p class="device-item-title">
                                    Shaft Power Meter
