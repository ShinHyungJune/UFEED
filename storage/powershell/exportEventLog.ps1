...
#초기세팅
#Get-EventLog -LogName System | Where-Object { $eventIDs -contains $_.EventID } | Select-Object TimeGenerated, EntryType, Source, EventID, Message | Export-Csv -Path $csvPath -NoTypeInformation -Encoding UTF8
